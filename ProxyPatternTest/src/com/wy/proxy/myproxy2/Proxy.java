...
public class Proxy {
	...
	public static Object newProxyInstance(Class infce, InvocationHandler h) throws Exception {
		...
		String str = "package com.wy.proxy.myproxy2;" + rt + "import java.lang.reflect.Method;" + rt
				+ "import com.wy.proxy.myproxy2.InvocationHandler;" + rt + "public class $Proxy0 implements "
				+ infce.getName() + " {" + rt + "	public $Proxy0(InvocationHandler h) {" + rt + "		this.h = h;"
				+ rt + "	}" + rt + "  private InvocationHandler h;" + rt + methodStr + rt + "}";
		// 产生代理类的java文件
		String filename = System.getProperty("user.dir") + "/bin/com/wy/proxy/myproxy2/$Proxy0.java";
		...
		Class c = cl.loadClass("com.wy.proxy.myproxy2.$Proxy0");
